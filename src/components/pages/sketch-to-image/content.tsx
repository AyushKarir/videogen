...
import { SketchToImageRequestBodyProps, SketchToImageResponse } from "@/lib/types/sketch-to-image";
...
import { CircleAlert, Edit2, LoaderCircle } from "lucide-react";
...
const Content = () => {
  const {
    ...
    updateResultWidth,
    updateEta,
    updateControlnetConditioningScale
  } = useSketchToImageStore();
  ...
  async function handleSubmit() {
    ...
    const requestBody: SketchToImageRequestBodyProps = {
      key: apiKey,
      model_id: state.model_id,
      init_image: state.init_image,
      prompt: state.prompt,
      negative_prompt: state.negative_prompt,
      auto_hint: state.auto_hint,
      guess_mode: state.guess_mode,
      strength: state.strength,
      controlnet_conditioning_scale: state.controlnet_conditioning_scale,
      ...
      controlnet_type: state.controlnet_type,
      controlnet_model: state.controlnet_model,
      lora_model: state.lora_model,
    ...
    try {
      ...
      const data: SketchToImageResponse = await response.json();
  ...
  function handleReset() {
    ...
    updateResultHeight("");
    updateResultWidth("");
    updateControlnetConditioningScale("0.9")
  }
  return (
    <div
