...
import {
  ExtendImageRequestBodyProps,
  ExtendImageResponse,
} from "@/lib/types/extend-image";
...
import { CircleAlert, LoaderCircle, ScreenShare } from "lucide-react";
...
const Content = () => {
  ...
  async function handleSubmit() {
    ...
    const requestBody: ExtendImageRequestBodyProps = {
      key: apiKey,
      seed: null,
      width: state.height,
      height: state.width,
      ...
      overlap_width: state.overlap_width,
      temp: state.temp,
      base64: state.base64,
    ...
    try {
      ...
      const data: ExtendImageResponse = await response.json();
